...
export interface CreateTradePayload {
  symbol: string; buyPrice: number; sellPrice: number; quantity: number
  entryDate: string; exitDate?: string; sector: string; emotionBefore?: string
  emotionAfter?: string; mistakeCategory?: string; convictionScore?: number; notes?: string
}
